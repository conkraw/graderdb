    ...
    if uploaded_files:
        ...
        if all(value is not None for value in file_data.values()):
            if st.button("Next"):
                ...
                df_8 = file_data.get("Canvas Quiz 1", None)
                df_9 = file_data.get("Canvas Quiz 2", None)
                df_10 = file_data.get("Canvas Quiz 3", None)
                df_11 = file_data.get("Canvas Quiz 4", None)
