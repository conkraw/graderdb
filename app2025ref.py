...
def main():
    ...
    st.markdown("""
- [Clinical Assessment Form](https://oasis.pennstatehealth.net/admin/course/e_manage/student_performance/setup_analysis_report.html)
- [Clinical Encounters](https://oasis.pennstatehealth.net/admin/course/experience_requirement/view_distribution_setup.html)
- [Procedure Encounters](https://oasis.pennstatehealth.net/admin/course/experience_requirement/view_distribution_setup.html)
- [Observed Handoff](https://oasis.pennstatehealth.net/admin/course/e_manage/student_performance/setup_analysis_report.html)
- [Observed History & Physical](https://oasis.pennstatehealth.net/admin/course/e_manage/student_performance/setup_analysis_report.html)
...
- [NBME Exam](https://oasis.pennstatehealth.net/admin/course/gradebook/)
...
- [Preceptor Tracker](https://oasis.pennstatehealth.net/admin/course/e_manage/manage_evaluators.html)
""")
    ...
    if uploaded_files:
        ...
        if all(value is not None for value in file_data.values()):
            if st.button("Next"):
                ...
                #Combine Procedure Log and Clinical Encounter
